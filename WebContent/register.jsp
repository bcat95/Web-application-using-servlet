		...
		<div id="primary" class="content-area sidebar-no clearfix bcpagewithbox">
			<div id="content" class="site-content " role="main">
    			...
    			<div style="margin:auto; width:400px; height:auto; padding-top:20px;">
        			<html:text name="registerForm" property="hoTen" styleClass="form-control" styleId="fullname"/><br/>
    				<html:text name="registerForm" property="email" styleClass="form-control" styleId="email"/><br/>
        			<html:text name="registerForm" property="tenDangNhap" styleClass="form-control" styleId="tenDN"/><br/>
        			<html:password name="registerForm" property="matKhau" styleClass="form-control" styleId="pw1"/><br/>
        			<html:password name="registerForm" property="confirmMatKhau" styleClass="form-control" styleId="pw2"/><br/>
        			<logic:equal name="registerForm" property="thongBao" value="1">
						<h4 style="color:red;"> Vui lòng điền đầy đủ thông tin!!! </h4>
					</logic:equal>
					<logic:equal name="registerForm" property="thongBao" value="2">
						<h4 style="color:red;"> Email không đúng định dạng!!! </h4>
					</logic:equal>
					<logic:equal name="registerForm" property="thongBao" value="3">
						<h4 style="color:red;"> Tên đăng nhập không được tồn tại ký tự đặc biệt!!! </h4>
					</logic:equal>
					<logic:equal name="registerForm" property="thongBao" value="4">
